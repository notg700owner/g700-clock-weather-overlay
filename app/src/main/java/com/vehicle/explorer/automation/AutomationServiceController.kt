...
object AutomationServiceController {
    const val ACTION_START = "com.g700.automation.action.START"
    const val ACTION_REFRESH_SETTINGS = "com.g700.automation.action.REFRESH_SETTINGS"
    ...
    fun refreshSettings(context: Context) {
        startServiceCompat(
            context,
            Intent(context, AutomationForegroundService::class.java).setAction(ACTION_REFRESH_SETTINGS)
        )
    }
